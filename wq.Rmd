...
```{r chlboxplot, fig.height = 8, fig.width = 12, fig.cap=paste0('Chlorophyll-a monthly averages from 1975-', maxyr -1, ' for the four bay segments. The monthly averages for ', maxyr, ' are shown in red.')}
