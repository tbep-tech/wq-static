...
# `r maxyr` Tampa Bay Water Quality Assessment
...
```{r sitemap, fig.height = 7, fig.width = 5, fig.align = "center", fig.cap=paste0("Chlorophyll attainment outcomes by site for ",  maxyr, ".")}
...
```{r chlmat, fig.height = 8, fig.width = 3, fig.align = "center", fig.cap=paste0("Attainment of bay segments for chlorophyll criteria from 1975 to ",  maxyr, ".")}
show_chlmatrix(epcdata, yrrng = c(1975, maxyr))
```
...
```{r sgacre, out.width="50%", fig.cap="Historic seagrass acreage estimates for Tampa Bay from 1950-2018", fig.align="center"}
