...
<p class="caption"><caption>(#tab:segtab) Results for `r maxyr`</caption></p>
```{r}
...
```{r attainmat, fig.height = 8, fig.width = 6, out.width = "90%", fig.align = "center", fig.cap=paste0("Decision matrix results from 1975 to ",  maxyr, ".")}
show_matrix(epcdata, yrrng = c(1975, maxyr), txtsz = 4)
```

```{r sitemap, fig.height = 5, fig.width = 4, fig.align = "center", out.width = "70%", fig.cap=paste0("Chlorophyll attainment outcomes by site for ",  maxyr, ".")}
