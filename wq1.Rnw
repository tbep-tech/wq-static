...
\begin{minipage}{0.45\textwidth}
\footnotesize
Water quality remained supportive of seagrass in Old Tampa Bay (OTB), Hillsborough Bay (HB), Middle Tampa Bay (MTB), and Lower Tampa Bay (LTB)(Table \ref{tab:segtab}, Figure \ref{fig:thrplot}). 2023 water quality conditions continued to improve from the prior year and were deemed supportive of seagrass (annual averages of chlorophyll and light penetration remained below management targets in all bay segments; Table \ref{tab:segtab}). Regardless, water quality conditions in OTB and HB remain under investigation based on significant seagrass coverage losses through 2022.
\end{minipage}
\hspace{0.1in}
\begin{minipage}{0.5\textwidth}
\footnotesize
