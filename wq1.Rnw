...
p <- show_matrix(epcdata, yrrng = c(1975, maxyr), txtsz = 5, abbrev = T) +
  theme(
...
pdf(here('figure', 'thrplot.pdf'), family = 'serif', height = 9, width = 10)
grid.arrange(
  p1leg,
...
\tiny \textit{\textbf{Note}: Continuing water quality monitoring support provided by the Environmental Protection Commission of Hillsborough County.  Consulting support provided by Janicki Environmental, Inc.  Full methods in Janicki, A., Wade, D., Pribble, R.J. 2000. \href{https://www.tbeptech.org/TBEP_TECH_PUBS/2000/TBEP_04_00Chlor-A.pdf}{TBEP Technical Report \#04\-00}.  Points in site map show attainment by targets that apply to whole segments.} \\
