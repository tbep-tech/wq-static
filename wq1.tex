...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in read\_importwq(xlsx, download\_latest\_epchc = T, tryurl = T, connecttimeout = 20): unused arguments (download\_latest\_epchc = T, tryurl = T, connecttimeout = 20)}}\end{kframe}
\end{knitrout}
...
\hline
\cellcolor{yellow}OTB&$~9.8$&$~8.5$&&$0.74$&$0.83$\tabularnewline
\cellcolor{green}HB&$11.0$&$13.2$&&$0.95$&$1.58$\tabularnewline
\cellcolor{green}MTB&$~5.7$&$~7.4$&&$0.56$&$0.83$\tabularnewline
\cellcolor{green}LTB&$~3.9$&$~4.6$&&$0.62$&$0.63$\tabularnewline
\hline
