...
\caption{\footnotesize Decision matrix results for 1975 to 2020 (April, May data missing for 2020).}
\label{fig:attainmat}
\end{figure}
...
\hline
\cellcolor{yellow}OTB&$~9.5$&$~8.5$&&$0.77$&$0.83$\tabularnewline
\cellcolor{green}HB&$10.5$&$13.2$&&$1.03$&$1.58$\tabularnewline
\cellcolor{green}MTB&$~5.5$&$~7.4$&&$0.55$&$0.83$\tabularnewline
\cellcolor{green}LTB&$~2.8$&$~4.6$&&$0.54$&$0.63$\tabularnewline
\hline
