...
pdf(here('figure', 'chlmat.pdf'), family = 'serif', height = 15, width = 4.5)
p
dev.off()
@
...
thrthm <- theme(
    ...
    axis.text.x = element_text(size = 10, colour = txtcol)
  )
...
pdf(here('figure', 'chlboxplot.pdf'), family = 'serif', height = 7, width = 8)
grid.arrange(
  p1leg,
